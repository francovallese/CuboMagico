...
*/
public class Material implements Runnable,Serializable
{
...
/**
	 * 
	 */
	private static final long serialVersionUID = 4297122044131897231L;
...
private String notice = "Copyright 2001 Ken Perlin. All rights reserved.";
   ...
   */
   public int table[] = new int[2 * res * res];
   ...
   */
   ...
   protected char Char = ' ';
   public Material setChar(char c) 
   {
	   Char = c;
	   return this;
   }
   ...
   */
   ...
   public int tableIndex(int ix, int iy, int iz) {
